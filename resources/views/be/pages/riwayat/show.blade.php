...
@push('meta-seo')
    <title>Data Riwayat Pasien - Posbindu</title>
    <meta content="Halaman Data Riwayat Pasien Posbindu" name="description">
                ...
                <div class="card-body pt-3 pb-md-1">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-start text-md-end">
                            <a href="{{ route('be.riwayat.list') }}" class="btn btn-dark fw-semibold">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
...
@section('content')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button class="btn btn-sm btn-danger fw-semibold d-flex align-items-center py-2"
                                                data-bs-toggle="modal" data-bs-target="#delRiwayat"
    ...
    {{-- Modal Delete --}}
    <div class="modal fade" tabindex="-1" id="delRiwayat" tabindex="-1" aria-labelledby="delRiwayatLabel"
        aria-hidden="true">
                ...
                <form action="{{ route('be.riwayat.act_delete') }}" method="post">
                    ...
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <input type="hidden" id="del-riwayat_id" name="riwayat_id" value="">
...
@push('js')
    <script>
        function edtData(id) {
            window.location.replace("{{ route('be.riwayat.edit') }}" + "/" + btoa(id));
        }

        function delData(id) {
            $('#del-riwayat_id').val(id);
        }
    </script>
@endpush
