...
@push('meta-seo')
    <title>Wawancara - Posbindu</title>
    <meta content="Halaman Wawancara Posbindu" name="description">
                        ...
                        <div class="col-md-6">
                            <nav aria-label="breadcrumb">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Data Wawancara</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-md-6 text-start text-md-end">
                            <a href="{{ route('be.wawancara.add') }}" class="btn btn-primary fw-semibold">Tambah
                                Wawancara</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="dataWawancaraTable" class="table align-te">
                            <thead>
                                <tr>
...
@push('js')
    ...
    <script>
        $('#dataWawancaraTable').DataTable();
    </script>
    <script>
        function showData(id) {
            window.location.replace("{{ route('be.wawancara.show') }}" + "/" + btoa(id));
        }
    </script>
@endpush
